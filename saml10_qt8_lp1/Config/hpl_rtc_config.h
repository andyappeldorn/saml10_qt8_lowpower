...
// <q> Periodic Interval Daily Event Output Enable
// <i> This bit indicates whether Periodic Daily event is is enabled and will be generated
// <id> rtc_perdeo
#ifndef CONF_RTC_PERDEO
#define CONF_RTC_PERDEO 0
#endif
